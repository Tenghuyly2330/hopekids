...
<div class="relative w-full hidden pt-4 lg:block z-40 bg-transparent">
    <div class="max-w-7xl mx-auto flex items-center justify-between gap-2 px-10 xl:px-0">
        ...
        <div class="flex items-center gap-4">
            <div class="hidden lg:flex items-center gap-2 text-[14px]" data-aos="fade-left" data-aos-duration="1000">
    ...
    <div x-show="open" x-cloak x-transition:enter="transition transform duration-300"
        ...
        <div class="w-full py-5 px-2">
            <div class="max-w-7xl mx-auto flex flex-col items-center justify-between gap-2">
                ...
                <!-- Social Icons -->
                <ul class="flex items-center gap-4 text-sm md:text-2xl relative z-10">
                    <li><a style="color:#007BFF" href="https://www.facebook.com/hopekidspp" target="__blank"><i
                                class="fa-brands fa-facebook"></i></a></li>
                    <li><a style="color:#039BE5" href="https://bio.link/hopekidsinfo" target="__blank"><i
                                class="fa-brands fa-telegram"></i></a></li>
                    <li><a style="color:white" href="https://www.tiktok.com/@hopekidsofficial?_t=ZS-8uAfAIUNOFe&_r=1"
                            target="__blank"><img src="{{ asset('assets/tiktok1.png') }}"
                                class="w-4 h-4 md:w-6 md:h-6" alt=""></a></li>
                    <li>
