        ...
        <div>
            <div class="relative z-10 pt-[15vh] lg:pt-[30vh] overflow-hidden">
                ...
                <div class="text-left max-w-[700px] mx-auto md:text-[18px] text-white text-[15px] lg:text-[16px] px-4" data-aos="fade-left" data-aos-duration="1000">
                    {!! app()->getLocale() === 'en' ? $banner_image->content_en : $banner_image->content_km !!}</div>
        ...
        <div class="flex flex-col items-center gap-4 md:gap-40 px-4 max-w-7xl mx-auto py-5 md:py-20">
            @foreach ($programs as $index => $item)
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-14 xl:gap-30" id="{{ $item->slug }}">
                    ...
                    <div  class="md:mt-5 text-start {{ $isOdd ? 'md:order-2' : 'md:order-1' }}" data-aos="fade-right" data-aos-duration="1000">
