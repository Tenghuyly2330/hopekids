    ...
    <section class="w-full h-[60vh] lg:h-screen">
        ...
        <div>
            ...
            <div class="relative z-10 pt-[15vh] lg:pt-[30vh] overflow-hidden">
                ...
                <div class="text-left max-w-[700px] mx-auto md:text-[18px] text-white text-[15px] lg:text-[16px] px-4"
        ...
        <div class="mt-10">
            @foreach ($messages as $message)
                <div class="flex justify-center flex-wrap gap-4 md:gap-30 overflow-hidden @if ($message->id !== 1) mt-10 md:mt-20 @endif">
                    <div class="w-[230px] h-[230px] rounded-full overflow-hidden" data-aos="fade-right"
                        data-aos-duration="1000">
                    ...
                    <div class="px-4" data-aos="fade-left" data-aos-duration="1000">
                        <div class="flex items-center justify-start">
                            <img src="{{ asset('assets/double_qout_left.png') }}" alt="">
                        </div>
                        ...
                        <div class="flex items-center justify-end">
                            <img src="{{ asset('assets/double_qout_right.png') }}" alt="" class="mt-5 md:mt-10">
                        </div>
                        <h1 class="text-[#1C0186] font-bold text-[16px] lg:text-[20px] mt-10">
