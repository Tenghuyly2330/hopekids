<x-app-layout>
    <div class="max-w-7xl mx-auto shadow-md rounded-lg p-6 my-2">
        <h2 class="text-2xl font-bold text-[#401457]">Edit Team</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input value="{{ old('name_en', $team->name_en) }}" name="name_en" id="name_en"
                    ...
                    <div>
                        ...
                        <input value="{{ old('position_en', $team->position_en) }}" name="position_en" id="position_en"
                            class="mt-1 block w-full p-2 border rounded-md text-black text-[12px]"></input>
                    ...
                    <div>
                        ...
                        <textarea name="content_en" id="content_en" rows="6"
                            class="mt-1 block w-full p-2 border rounded-md text-black text-[12px]">{{ old('content_en', $team->content_en) }}</textarea>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input value="{{ old('name_km', $team->name_km) }}" name="name_km" id="name_km"
                            class="mt-1 block w-full p-2 border rounded-md text-black text-[12px]"></input>
                    ...
                    <div>
                        ...
                        <input value="{{ old('position_km', $team->position_km) }}" name="position_km" id="position_km"
                            class="mt-1 block w-full p-2 border rounded-md text-black text-[12px]"></input>
                    ...
                    <div>
                        ...
                        <textarea name="content_km" id="content_km" rows="6"
                            class="mt-1 block w-full p-2 border rounded-md text-black text-[12px]">{{ old('content_km', $team->content_km) }}</textarea>
