                    ...
                    @foreach ($certificates as $certificate)
                        <tr class="border border-[#4FC9EE]">
                            ...
                            <td class="py-1 px-4 text-xs max-w-[200px] border-r border-[#4FC9EE]">
                                <img src="{{ asset($certificate->image) }}" alt="" class="w-12 h-12">
                            </td>
                            ...
                            <td class="py-4 px-4 text-xs max-w-[200px] border-r border-[#4FC9EE]">
                                <div class="flex items-center space-x-2">
                                    <a href="{{ route('certificates.edit', $certificate->id) }}" title="Edit">
                                    ...
                                    <a href="#" title="Delete"
                                        onclick="event.preventDefault(); deleteRecord('{{ route('certificates.delete', $certificate->id) }}')">
