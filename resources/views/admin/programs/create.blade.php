<x-app-layout>
    <div class="max-w-7xl mx-auto shadow-md rounded-lg p-6 my-2">
        <h2 class="text-2xl font-bold text-[#401457]">Create Program</h2>
        <form action="{{ route('program.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="number_en" id="number_en"
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="number_km" id="number_km"
                            class="mt-1 block w-full p-2 border rounded-md text-[#000] text-sm">
