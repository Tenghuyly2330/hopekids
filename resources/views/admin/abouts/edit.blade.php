    ...
    <div class="max-w-7xl mx-auto shadow-md rounded-lg p-6 my-2">
        ...
        <form action="{{ route('about_backend.update', $about->id) }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="content_en" id="content_en" rows="6"
                            class="mt-1 block w-full p-2 border rounded-md text-black text-[12px]">{{ old('content_en', $about->content_en) }}</textarea>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="content_km" id="content_km" rows="6"
                            class="mt-1 block w-full p-2 border rounded-md text-black text-[12px]">{{ old('content_km', $about->content_km) }}</textarea>
            ...
            <div>
                ...
                <label for="dropzone-file{{ $about->id }}" id="drop-area"
                    ...
                    <div class="flex flex-col items-center justify-center pt-5 pb-6 w-full h-full bg-contain bg-center bg-no-repeat rounded-md text-center"
                        id="img-preview" style="background-image: url('{{ asset($about->image) }}')">
                    ...
                    <input id="dropzone-file{{ $about->id }}" type="file" class="hidden" name="image"
