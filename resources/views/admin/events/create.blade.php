<x-app-layout>
    <div class="max-w-7xl mx-auto bg-white shadow-md rounded-lg p-6 my-2">
        ...
        <form action="{{ route('event_backend.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            @csrf
            ...
            <div class="w-full grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="p-0 space-y-4">
                    ...
                    <div>
                        ...
                        <input value="{{ old('title_km') }}" type="text" name="title_km" id="title_km"
                            class="mt-1 block w-full p-2 border rounded-md text-[#000] text-sm">
                    ...
                    <div>
                        ...
                        <textarea name="content_km" id="content_km" rows="4"
                            class="mt-1 block w-full p-2 border rounded-md text-[#000] text-sm">{{ old('content_km') }}</textarea>
