<x-app-layout>
    <div class="max-w-7xl mx-auto shadow-md rounded-lg p-6 my-2">
        <h2 class="text-2xl font-bold text-[#401457]">Edit Experince</h2>
        <form action="{{ route('experince.update', $experince->id) }}" method="POST" enctype="multipart/form-data"
            class="space-y-4">
            @csrf
            @method('PATCH')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input value="{{ old('year', $experince->year) }}" type="text" name="year" id="year"
                ...
                <div>
                    ...
                    <input value="{{ old('branch', $experince->branch) }}" type="text" name="branch" id="branch"
                        class="mt-1 block w-full p-2 border rounded-md text-[#000] text-sm">
                ...
                <div>
                    ...
                    <input value="{{ old('student', $experince->student) }}" type="text" name="student" id="student"
                        class="mt-1 block w-full p-2 border rounded-md text-[#000] text-sm">
                ...
                <div>
                    ...
                    <input value="{{ old('staff', $experince->staff) }}" type="text" name="staff" id="staff"
                        class="mt-1 block w-full p-2 border rounded-md text-[#000] text-sm">
