            ...
            <header>
                <div class="image-text">
                    ...
                    <div class="text header-text">
                        <span class="name uppercase">Hope Kids</span>
                    </div>
                </div>
            ...
            <div class="menu-bar">
                <div class="menu max-h-[80vh] overflow-y-auto scrollbar-hidden">
                    <ul class="manu-links">
                        ...
                        <li
                            class="nav-link {{ Request::is('article_backend') ? 'bg-[#000] rounded-md !text-[#ffffff]' : '' }}">
                            <a href="{{ url('article_backend') }}">
                                <i class='bx bxl-vimeo icon'></i>
                        ...
                        <li
                            class="nav-link {{ Request::is('event_backend') ? 'bg-[#000] rounded-md !text-[#ffffff]' : '' }}">
                            <a href="{{ url('event_backend') }}">
                                <i class='bx bxl-vimeo icon'></i>
