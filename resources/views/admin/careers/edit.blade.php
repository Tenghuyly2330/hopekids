<x-app-layout>
    <div class="max-w-7xl mx-auto shadow-md rounded-lg p-6 my-2">
        <h2 class="text-2xl font-bold text-[#401457]">Edit Career</h2>
        <form action="{{ route('career_backend.update', $career->id) }}" method="POST" enctype="multipart/form-data"
            class="space-y-4">
            @csrf
            @method('PATCH')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input value="{{ old('position_en', $career->position_en) }}" name="position_en" id="position_en"
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input value="{{ old('position_km', $career->position_km) }}" name="position_km" id="position_km"
                            class="mt-1 block w-full p-2 border rounded-md text-black text-[12px]"></input>
