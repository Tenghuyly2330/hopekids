...
@section('content')
    <div class="my-2 px-2 md:px-4 flex items-center justify-between">
        <a href="{{ route('career_backend.create') }}"
                        ...
                        <tr class="border border-[#4FC9EE]">
                            ...
                            <td class="py-4 px-4 text-xs max-w-[200px] border-r border-[#4FC9EE]">
                                <div class="flex items-center space-x-2">
                                    <a href="{{ route('career_backend.edit', $career->id) }}" title="Edit">
                                    ...
                                    <a href="#" title="Delete"
                                        onclick="event.preventDefault(); deleteRecord('{{ route('career_backend.delete', $career->id) }}')">
