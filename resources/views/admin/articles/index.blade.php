...
@section('content')
    <div class="my-2 px-2 md:px-4 flex items-center justify-between">
        <a href="{{ route('article_backend.create') }}"
                    ...
                    @foreach ($articles as $article)
                        <tr class="border border-[#4FC9EE]">
                            ...
                            <td class="py-1 px-4 text-xs max-w-[200px] border-r border-[#4FC9EE]">
                                <img src="{{ asset($article->image) }}" alt="" class="w-12 h-12">
                            </td>
                            ...
                            <td class="py-4 px-4 text-xs max-w-[200px] border-r border-[#4FC9EE]">
                                <div class="flex items-center space-x-2">
                                    <a href="{{ route('article_backend.edit', $article->id) }}" title="Edit">
                                    ...
                                    <a href="#" title="Delete"
                                        onclick="event.preventDefault(); deleteRecord('{{ route('article_backend.delete', $article->id) }}')">
