        ...
        <div class="border border-[#fff] max-h-[70vh] overflow-y-auto">
            <table class="min-w-full table-fixed">
                <thead class="text-[#fff] sticky top-0 z-10 bg-[#4FC9EE] border border-[#4FC9EE]">
                    <tr>
                        <th class="text-left py-3 px-4 text-xs w-[200px] border-r border-[#fff]">Platform Name</th>
                        <th class="text-left py-3 px-4 text-xs w-[200px] border-r border-[#fff]">Link</th>
